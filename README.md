...
- [🚀 프로젝트 실행 방법](#-프로젝트-실행-방법)
  ...
  - [설치 및 실행](#설치-및-실행)
- [✨ 구현 기능](#-구현-기능)
  - [현재 위치 날씨 조회](#현재-위치-날씨-조회)
  - [장소 검색](#장소-검색)
  - [즐겨찾기](#즐겨찾기)
  - [반응형 디자인](#반응형-디자인)
- [🛠 기술적 의사결정](#-기술적-의사결정)
  - [FSD 아키텍처 적용](#fsd-아키텍처-적용)
  - [코드 구조화 및 유지보수성](#코드-구조화-및-유지보수성)
  - [OpenWeatherMap One Call 3.0 → Free API 폴백](#openweathermap-one-call-30--free-api-폴백)
  - [Kakao API 양방향 활용](#kakao-api-양방향-활용)
  - [useSyncExternalStore 기반 상태 관리](#usesyncexternalstore-기반-상태-관리)
  - [검색 성능 최적화](#검색-성능-최적화)
  - [TanStack Query 설정](#tanstack-query-설정)
  - [계층적 에러 처리](#계층적-에러-처리)
  - [테스트 전략](#테스트-전략)
  - [UX 고려사항](#ux-고려사항)
  - [접근성](#접근성)
  - [SEO](#seo)
  - [SPA 라우팅 처리](#spa-라우팅-처리)
- [📦 기술 스택](#-기술-스택)
- [📁 프로젝트 구조](#-프로젝트-구조)
...
상세 페이지에서는 현재 기온, 최저/최고 기온, 시간대별 기온을 확인할 수 있습니다.
